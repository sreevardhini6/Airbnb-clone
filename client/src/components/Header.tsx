...
export const Header = () => {
        return <header className=" p-4 flex bg-slate-100 bg-opacity-85  justify-between capitalize border-b-2 border-slate-100">
            ...
            <span   className="font-bold text-xl">Airbnb</span>
                ...
                <div className="flex  gap-2 border border-gray-200 shadow-md shadow-gray-300 font-semibold bg-white rounded-full py-2 px-4  cursor-pointer">
        ...
        <div className="flex items-center gap-2 border border-gray-200  font-semibold bg-white rounded-full py-2 px-4 cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-5">
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
</svg>
    <Link to={"/login"} className="bg-gray-300 rounded-full p-1   text-slate-500 border-gray border overflow-hidden">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-5 relative">
